...
const votation2 = new Votation('Qual sua fruta favorita?');
votation2.addVotationOption({ option: 'Maçã', numberOfVotes: 0 });
votation2.addVotationOption({ option: 'Laranja', numberOfVotes: 0 });
votation2.addVotationOption({ option: 'Abacaxi', numberOfVotes: 0 });
votation2.vote(0);
votation2.vote(0);
votation2.vote(1);
votation2.vote(1);
